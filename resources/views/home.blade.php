                ...
                <div class="position-absolute top-0 start-0 w-100 h-100"
                    ...
                    <div
                        ...
                        <div class="d-flex gap-2 pt-2">
                            <button class="btn btn-outline-info px-3 btn-lg button"  > <i class="bi bi-play-fill"></i>Get Started</button>
            ...
            <!-- Right: Text -->
                 ...
                 <div class="col-lg-6 hero-text d-flex flex-column justify-content-center mt-5 text-center">
                    <div class="container text-center ">
                     ...
                     <a href="{{route('tutorials')}}" class="button btn btn-outline-info btn-lg text-center "> <i class="bi bi-play-fill"></i>Get Started</a>
                 </div>
             </div>
        </div>
    </div>
...
{{-- -------------------------------------------------------------- --}}
 ...
 <div class="container mt-5">
          ...
          <div class="col-md-6 mt-5 mt-md-0 ">
              ...
              <div class="row ">
                  <div class="col-6">
                      ...
                      <p class="text-white"data-aos="zoom-out-up">We offer a wide range of programming courses tailored to all levels</p>
                  </div>
                  <div class="col-6">
                      <div class="d-flex mt-md-5 align-items-sm-center gap-2 mb-3 "data-aos="zoom-out">
                      ...
                      <p class="text-white"data-aos="zoom-out-up">Each topic is clearly explained with step-by-step guidance</p>
                  </div>
              </div>
              <div class="row">
                  <div class="col-6">
    ...
    <div class="container pt-5 gap-3">
        <h1 class="display-6 text-center text-light pt-3 fw-bold"data-aos="zoom-in-up">learn at your own pace from anywhere </h1>
